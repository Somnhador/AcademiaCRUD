...
<head>
    ...
    <title>DarkSide Academia - Gerenciar Funcionários</title>
    ...
    <div class="container mt-5">
        ...
        <div id="borda">
            ...
            <div class="text-center mb-4">
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#cadastroModal">Cadastrar Funcionário</button>
            </div>
                    ...
                    <form method="POST">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title text-center" id="cadastroModalLabel">Cadastrar Funcionário</h5>
            ...
            <h3 class="text-center" style="color: white;">Lista de Gerentes e Funcionários</h3><br>
                        ...
                        <?php foreach ($funcionario as $funcionario) : ?>
                            <div class="col-12 mb-3">
                                <div class="card shadow-sm card-hover" data-bs-toggle="modal" data-bs-target="#viewModal<?php echo $funcionario['id']; ?>">
                                    <?php
                                    if ($funcionario['tipoDeConta'] == 'Gerente' || $funcionario['tipoDeConta'] == 'Funcionário') {
                                    ?>
                                        <div class="card-body">
                            ...
                            <div class="modal fade" id="editModal<?php echo $funcionario['id']; ?>" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <form method="POST">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title text-center">Editar Informação de Funcionário</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                            ...
                            <div class="modal fade" id="deleteModal<?php echo $funcionario['id']; ?>" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Deseja realmente excluir os dados do Funcionário <strong><?php echo htmlspecialchars($funcionario['nomeCompletoPF']); ?></strong>, do CPF <strong><?php echo htmlspecialchars($funcionario['cpf']); ?></strong> ?</p>
                                        </div>
                                        <div class="modal-footer">
                            ...
                            <div class="modal fade" id="viewModal<?php echo $funcionario['id']; ?>" tabindex="-1" aria-labelledby="viewModalLabel<?php echo $funcionario['id']; ?>" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="viewModalLabel<?php echo $funcionario['id']; ?>">Detalhes do Funcionário</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
